...
def resnet_arg_scope(is_training=True,weight_decay=0.0001,batch_norm_decay=0.997,batch_norm_epsilon=1e-5,batch_norm_scale=True):
    ...
    with slim.arg_scope([slim.conv2d],weights_regularizer=slim.l2_regularizer,weights_initializer=slim.variance_scaling_initializer(),activation_fn=tf.nn.relu,
